...
internal class QueueUsingTwoStacksDeOptimizedTest {

    private lateinit var queue: QueueUsingTwoStacksDeOptimized<Int>

    @BeforeEach
    fun beforeEach() {
        queue = QueueUsingTwoStacksDeOptimized<Int>()
    }
