...
internal class StackUsingTwoQueuesPopOptimizedTest {

    private lateinit var stack: StackUsingTwoQueuesPopOptimized<Int>

    @BeforeEach
    fun beforeEach() {
        stack = StackUsingTwoQueuesPopOptimized<Int>()
    }
