...
import stack.StackUsingStaticArray


internal class StackUsingStaticArrayTest {

    private lateinit var stack: StackUsingStaticArray<Int>

    @BeforeEach
    fun beforeEach() {
        stack = StackUsingStaticArray<Int>()
    }
