...
internal class StackUsingTwoQueuesPushOptimizedTest {

    private lateinit var stack: StackUsingTwoQueuesPushOptimized<Int>

    @BeforeEach
    fun beforeEach() {
        stack = StackUsingTwoQueuesPushOptimized<Int>()
    }
