...
internal class DisjointSetUnionBySizeTest {

    @Test
    fun `test number of subsets`() {
        val disjointSet = DisjointSetUnionBySize(5)
    ...
    fun `test connectivity`() {
        val size = 7
        val disjointSet = DisjointSetUnionBySize(size)
